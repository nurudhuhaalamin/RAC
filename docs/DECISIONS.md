...
| 🔴 **D-15** | Font isi artikel: **Inter** (lebih nyaman dibaca panjang) atau **Montserrat** (konsisten brand)? | **T-212**, dan sebagian **T-104** | Montserrat sangat baik untuk UI dan judul pendek, tapi melelahkan untuk artikel 1.500+ kata — lebar huruf seragam dan aperture tertutup memperlambat pembacaan panjang. Kalau tetap Montserrat: naikkan `line-height` ke 1,8 dan turunkan lebar baca ke 62 karakter. |
...
| 🔴 **D-17** | "E-Learning" muncul di footer mockup — apakah ini layanan yang benar-benar akan ada? | peta keyword, IA | Kalau tidak ada, jangan dibuat menunya. Kalau ada, ia butuh klaster keyword dan halaman sendiri. |
